...
//---------------------------------//
 ...
 backgroundmenumusic.stop();
  ...
  apply = new Button(240, 500, 100, 40, "Apply", 20, function() {beurt = beurt + 1;
            keuze = 0                                                        });
  

  skin1  = new ButtonPlayerPicker(40, 200, 200, 200, "Menu", 20, function() {keuze = 1});
  skin2  = new ButtonPlayerPicker(280, 200, 200, 200, "Menu", 20, function() {keuze = 2});
  skin3  = new ButtonPlayerPicker(520, 200, 200, 200, "Menu", 20, function() {keuze = 3});
  skin4  = new ButtonPlayerPicker(760, 200, 200, 200, "Menu", 20, function() {keuze = 4});
